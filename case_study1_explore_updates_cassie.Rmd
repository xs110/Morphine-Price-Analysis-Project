...
#compare AIC  for influential points analysis
aic_m7 = AIC(m7)
aic_m10 = AIC(m10)

if (aic_m7 < aic_m10 ) {
  cat("AIC is lower for the orginal model ")
} else if (aic_m7 > aic_m10) {
  cat("AIC is lower for the model adjusted for the outliers")
} else {
  cat("AIC is the same for both datasets")
}
